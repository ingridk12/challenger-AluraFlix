...
export function Banner() {
    ...
    return (
        <Anuncio>
            <AnuncioContenido>
                <AnuncioDescripcion>
                    <AnuncioTitulo>Challenge AluraFlix</AnuncioTitulo>
                ...
                <AnuncioLink href="https://www.youtube.com/watch?v=aJAhVIZKEKI" target="__blank">
                    <AnuncioImagen src='https://i.ytimg.com/an_webp/aJAhVIZKEKI/mqdefault_6s.webp?du=3000&sqp=CPqVi7wG&rs=AOn4CLC55PBgJ74qTziduVsCmsWDlKCUAQ' />
                </AnuncioLink>
            </AnuncioContenido>
        </Anuncio>
    );
